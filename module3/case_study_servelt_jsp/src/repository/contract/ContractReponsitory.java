...
public class ContractReponsitory implements IContractReponsitory {
    ...
    @Override
    public List<Contract> sellectAllContract() {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                contractList.add(new Contract(id,starDate,endDate,deposit,totalMoney,employee,customer,service));
            }
