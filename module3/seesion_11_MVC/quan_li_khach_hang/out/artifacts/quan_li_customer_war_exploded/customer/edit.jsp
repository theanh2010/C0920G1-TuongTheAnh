...
<p>
    <a href="${pageContext.request.contextPath}/customers" class="btn btn-warning">Back to customer list</a>
</p>
<form method="post">
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td></td>
                <td><input type="submit" value="Update customer" class="btn btn-danger"></td>
            </tr>
        </table>
    </fieldset>
</form>
