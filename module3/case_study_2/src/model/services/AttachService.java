...
public class AttachService {
    protected int attach_service_id;
    protected String attach_service_name;
    protected double attach_service_cost;
    protected int attach_service_unit;
    protected String attach_service_status;
