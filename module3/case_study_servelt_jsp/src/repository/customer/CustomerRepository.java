...
public class CustomerRepository implements ICustomerRepository {
    ...
    private static final String INSERT_CUSTOMER = "INSERT INTO customer (customer_id," +
            " customer_name," +
            " customer_birthday," +
            " customer_gender," +
            " customer_id_card," +
    ...
    public List<Customer> selectAllCustomer() {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                customerList.add(new Customer(id,name,birthday,gender,idCard,phone,email,address,customerType));
            }
